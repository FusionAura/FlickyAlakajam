...
public class SimpleEnemyMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Reverse == true)
            transform.Translate(Vector3.forward * PlatformSpdX * Time.deltaTime);
        else
            transform.Translate(Vector3.forward * -PlatformSpdX * Time.deltaTime);
        ...
        if (ReverseY == true)
            transform.Translate(Vector3.up * PlatformSpdY * Time.deltaTime);
        else
            transform.Translate(Vector3.up * -PlatformSpdY * Time.deltaTime);
        //Control Z Movement
        if (timerZ >= timerMaxZ)
        ...
        if (ReverseZ == true)
            transform.Translate(Vector3.right * -PlatformSpdZ * Time.deltaTime);
        else
            transform.Translate(Vector3.right * PlatformSpdZ * Time.deltaTime);
    }
}
